...
Build and maintain a host-first audio system for RAID NIGHT that supports one music loop per level, scalable combat audio for players/bosses/core enemies, placeholder-friendly dialog VO for Levels 5 and 6, and drop-in asset integration through stable logical keys and docs.
...
### Read Access
- `/mnt/c/Workspace/bachelorPartyGame/` — full project read access

### Write Access
- `/mnt/c/Workspace/bachelorPartyGame/client/host/systems/` — host audio runtime
- `/mnt/c/Workspace/bachelorPartyGame/client/controller/` — minimal local audio cues
- `/mnt/c/Workspace/bachelorPartyGame/shared/` — audio config and shared identifiers
- `/mnt/c/Workspace/bachelorPartyGame/docs/AUDIO.md` and adjacent docs when audio contracts change
- `/mnt/c/Workspace/bachelorPartyGame/_bmad/memory/agent-voljin/` — your sanctum, full read/write

### Deny Zones
- `.env` files, credentials, secrets, tokens
- deep combat logic in `/mnt/c/Workspace/bachelorPartyGame/server/` unless Cyby explicitly reassigns ownership
