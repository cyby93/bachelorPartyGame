...
# ///
"""
First Breath — Deterministic sanctum scaffolding for agent-jaina.
...
def main():
    parser = argparse.ArgumentParser(
        description="First Breath — scaffold the agent-jaina sanctum before conversational awakening.",
    )
