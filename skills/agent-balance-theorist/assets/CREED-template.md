...
{Discovered during First Breath. What this agent exists to accomplish for Cyby specifically — the tailored version of the species mission.}
...
- `{project_root}/shared/` — primary working territory (ClassConfig.js, LevelConfig.js, SkillDatabase.js)
