...
// Export for CommonJS (Node.js) - for server.js
if (typeof module !== 'undefined' && module.exports) {
  // Load SkillDatabase for Node.js
  let SkillDatabaseNode;
  try {
    SkillDatabaseNode = require('./SkillDatabase.js');
  } catch (e) {
    console.error('Failed to load SkillDatabase in Node.js:', e);
    SkillDatabaseNode = {};
  }
  
  // Rebuild CLASSES for Node.js with the loaded SkillDatabase
  const CLASSES_NODE = {
    [CLASS_NAMES.WARRIOR]: {
      name: 'Warrior',
      color: '#3498db',
      hp: 150,
      speed: 2.5,
      skills: SkillDatabaseNode['Warrior'] || []
    },
    [CLASS_NAMES.PALADIN]: {
      name: 'Paladin',
      color: '#f39c12',
      hp: 140,
      speed: 2.3,
      skills: SkillDatabaseNode['Paladin'] || []
    },
    [CLASS_NAMES.SHAMAN]: {
      name: 'Shaman',
      color: '#9b59b6',
      hp: 110,
      speed: 2.6,
      skills: SkillDatabaseNode['Shaman'] || []
    },
    [CLASS_NAMES.HUNTER]: {
      name: 'Hunter',
      color: '#27ae60',
      hp: 100,
      speed: 3.0,
      skills: SkillDatabaseNode['Hunter'] || []
    },
    [CLASS_NAMES.PRIEST]: {
      name: 'Priest',
      color: '#ecf0f1',
      hp: 90,
      speed: 2.4,
      skills: SkillDatabaseNode['Priest'] || []
    },
    [CLASS_NAMES.MAGE]: {
      name: 'Mage',
      color: '#e74c3c',
    ...
    [CLASS_NAMES.DRUID]: {
      ...
      hp: 120,
      speed: 2.7,
      skills: SkillDatabaseNode['Druid'] || []
    },
    [CLASS_NAMES.ROGUE]: {
      name: 'Rogue',
      color: '#34495e',
      hp: 95,
      speed: 3.2,
      skills: SkillDatabaseNode['Rogue'] || []
    }
  };
  
  module.exports = { CLASS_NAMES, CLASSES: CLASSES_NODE, normalizeClassName };
}
