...
# ///
"""
First Breath — Deterministic sanctum scaffolding for agent-saurfang.
...
def main():
    parser = argparse.ArgumentParser(
        description="First Breath — scaffold the agent-saurfang sanctum before conversational awakening.",
    )
