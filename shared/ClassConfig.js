...
export const CLASSES = {
  ...
  Priest:      { name: 'Priest',        color: '#ecf0f1', hp:  1190, speed: 1.8, skills: SkillDatabase.Priest      },
  ...
  Warlock:     { name: 'Warlock',       color: '#8b5cf6', hp:  90, speed: 2.4, skills: SkillDatabase.Warlock     },
  DeathKnight: { name: 'Death Knight',  color: '#60a5fa', hp: 160, speed: 2.2, skills: SkillDatabase.DeathKnight },
}
