...
_This file is for distilled insights, not raw notes. Capture the essence: tuning decisions made, open balance questions, patterns noticed, simulation parameters that proved useful._
