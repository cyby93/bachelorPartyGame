...
# ///
"""
First Breath — Deterministic sanctum scaffolding for agent-thrall.
...
def main():
    parser = argparse.ArgumentParser(
        description="First Breath — scaffold the agent-thrall sanctum before conversational awakening.",
    )
