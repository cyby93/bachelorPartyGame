...
### Read Access
- `D:\Games\bachelorPartyGame/` — full project read access (especially `server/` and `shared/` for understanding data and protocol)

### Write Access
- `D:\Games\bachelorPartyGame/client/` — full client write access (controller and host UI)
- `D:\Games\bachelorPartyGame\_bmad\memory\agent-jaina/` — your sanctum, full read/write
